    ...
    <section class="checkout spad">
        <div class="container">
            <div class="checkout__form">
                <form method="post" action="{{Route('getcheck')}}">
                    @csrf
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
                                <p>Order notes</p>
                                <input type="text"
                                placeholder="Notes about your order, e.g. special notes for delivery." name="oder_note">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <ul class="checkout__total__products">
                                    @foreach ($carts['items'] as $key => $value )
